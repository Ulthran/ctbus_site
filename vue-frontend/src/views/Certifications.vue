...
const extraCerts = {
  ...
  "LinkedIn Learning": [
    {
      href: "CDN_URL/certificates/aws_mls_c01_prep.pdf",
      title: "AWS Machine Learning ('23)",
    },
    {
      href: "CDN_URL/certificates/devops_foundations_cicd.pdf",
      title: "DevOps Foundations: CI/CD ('23)",
    },
    {
      href: "CDN_URL/certificates/learning_amazon_web_services_for_developers.pdf",
      title: "Learning AWS for Developers ('23)",
    },
    { href: "CDN_URL/certificates/learning_docker.pdf", title: "Docker ('23)" },
    {
      href: "CDN_URL/certificates/learning_docker_compose.pdf",
      title: "Docker Compose ('23)",
    },
    {
      href: "CDN_URL/certificates/25_github_configuration_files_you_should_be_using.pdf",
      title: "25 GitHub Configuration Files You Should Be Using ('23)",
    },
    {
      href: "CDN_URL/certificates/scrum_master.pdf",
      title: "Scrum Master ('23)",
    },
    {
      href: "CDN_URL/certificates/supporting_allyship_and_antiracism_at_work.pdf",
      title: "Supporting Allyship and Antiracism at Work ('23)",
    },
    {
      href: "CDN_URL/certificates/strategic_thinking.pdf",
      title: "Strategic Thinking ('23)",
    },
  ],
  "Techstrong Learning": [
    {
      href: "CDN_URL/certificates/build_AI_native_foundation.pdf",
      title: "AI-Native Foundations for Enterprise Apps ('24)",
    },
    {
      href: "CDN_URL/certificates/future_of_AI_assisted_dev_and_code_qual_cert.pdf",
      title: "Future of AI Assisted Development and Code Quality ('23)",
    },
  ],
  "Misc and Old": [
    {
      href: "CDN_URL/certificates/IBM_quantum_challenge_fall_2020.pdf",
      title: "IBM - Quantum Challenge - Foundational ('20)",
    },
    {
      href: "CDN_URL/certificates/scala_lang_prof.pdf",
