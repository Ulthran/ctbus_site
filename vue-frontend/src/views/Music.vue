...
<template>
  ...
  >
      <div class="d-flex justify-center my-4 mx-6">
        <v-btn class="p-6" icon href="https://open.spotify.com/user/charlie_bushman?si=0dd732a8d6da46b6" target="_blank">
          <v-icon icon="fa-brands fa-spotify" />
        </v-btn>
        <v-btn class="p-6" icon href="https://0qn7o9e6pd.execute-api.us-east-1.amazonaws.com/Prod/" target="_blank">
