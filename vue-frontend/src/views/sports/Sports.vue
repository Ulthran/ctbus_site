<template>
  <v-container class="d-flex flex-column align-center">
    ...
    <v-card class="mt-8 pa-4 text-center" max-width="600">
      ...
      <p class="text-body-1">I grew up on the sidelines of my parents' summer league games. Now I play for a club team that placed 5th in the northeast this year and has been a national champ in the past. I also play for the same summer league team my parents did (it's 40 years old!).</p>
    ...
    <v-card class="mt-8 pa-4 text-center" max-width="600">
      ...
      <p class="text-body-1">Winter break, 2019, I came home and was sick for a week. So I played chess the whole time. And I've kept playing since (only sometimes getting better).</p>
      <v-row class="py-4" align="center" justify="space-around">
        <v-col cols="auto">
    ...
    <v-card class="mt-8 pa-4 text-center" max-width="600">
      ...
      <v-row class="py-4" align="center" justify="center">
        <v-col cols="auto">
          <BadmintonIcon style="width:48px;height:48px" />
        </v-col>
      </v-row>
    </v-card>
    ...
    <v-card class="mt-8 pa-4 text-center" max-width="600">
      ...
      <p class="text-body-1">I played squash for a few years somewhere around middle school. My crowing achievement was winning the Marblehead YMCA snowflake holiday tournament.</p>
      <v-row class="py-4" align="center" justify="center">
        <v-col cols="auto">
...
import { faBolt, faChess, faPuzzlePiece, faTrain, faStopwatch, faSun, faPersonSkiing, faFutbol } from '@fortawesome/free-solid-svg-icons'
import { library } from '@fortawesome/fontawesome-svg-core'
import BatmanIcon from '../../components/icons/Batman.svg'
import BruisesIcon from '../../components/icons/Bruises.svg'
import WildcardIcon from '../../components/icons/Wildcard.svg'
import BulletIcon from '../../components/icons/Bullet.svg'
import BadmintonIcon from '../../components/icons/Badminton.svg'
import SquashIcon from '../../components/icons/Squash.svg'

library.add(faBolt, faChess, faPuzzlePiece, faTrain, faStopwatch, faSun, faPersonSkiing, faFutbol)
