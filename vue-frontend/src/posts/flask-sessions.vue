...
<template>
  ...
  <v-container class="py-4 blog-content">
    ...
    <Paragraph>Then I realized I had made a signinificant oversight in my initial overview of the options available to me. Flask (without Flask Session) has a built in session object. And that session stores data locally to the user's computer. I tried this way out and it worked immediately. Even better, it incurs no added cost and doesn't add any dependencies to the site (keeping bundle size down). So this is what I went with. And it still gives the ability to have a page where you (the user) can <a href="/session" target="_blank" >view and delete session data</a> from this site.</Paragraph>
