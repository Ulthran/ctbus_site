...
<template>
  ...
  <v-container class="py-4 blog-content">
    ...
    <CodeBlock :code="testsYaml" language="yaml" />
    ...
    <CodeBlock :code="buildYaml" language="yaml" />
    ...
    <CodeBlock :code="policyJson" language="json" />
    ...
    <CodeBlock :code="deployYaml" language="yaml" />
    ...
    <CodeBlock :code="conftestPy" language="python" />
    ...
    <CodeBlock :code="testTitlePy" language="python" />
    ...
    <CodeBlock :code="pageObjPy" language="python" />
    ...
    <CodeBlock :code="accessYaml" language="yaml" />
