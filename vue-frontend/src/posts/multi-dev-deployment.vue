...
<template>
  ...
  <v-container class="py-4 blog-content">
    ...
    <Paragraph>The end result for me is just removing the occasional dev headache. However, if there were a team of developers working on a site, this would be an absolute essential. Keeping dev deployments from overlapping requires more work but is well worth the siloed testing environments you end up with. And with the CloudFormation script, it's easy to automate the deletion of all those resources when the feature branch is deleted.</Paragraph>
  </v-container>
</template>
